"This is a example of data validation with Python"
import re
...
def validar():
    "We defined a new method for the data validation"
    ...
    if entry1.get() == "":
        ...
        if len(password) < 8:
            messagebox.showerror(message="La contraseña no es valida, es menor de 8 caracteres",
             title="Error de contraseña")
        elif len(password) == 15:
            messagebox.showerror(message="La contraseña no es valida, es mayor de 15 caracteres",
             title="Error de contraseña")
        elif re.search('[0-9]', password) is None:
            messagebox.showerror(message="La contraseña no es valida, asegurate de que tenga al"
            + " menos un número", title="Error de contraseña")
        elif re.search('[A-Z]', password) is None:
            messagebox.showerror(message="La contraseña no es valida, asegurate de que tenga al"
            + " menos una letra mayuscula", title="Error de contraseña")
        else:
    ...
    if entry3.get() == "":
        ...
        if re.match(r'^[(a-z,ñ0-9\_\-\.)]+@[(a-z)]+\.[(a-z)]{2,15}$', correo.lower()):
    ...
    if entry4.get() == "":
        ...
        if re.match('^[(1-35)]+-[(Enero),(Febrero),(Marzo),(Abril),(Mayo),(Junio),(Julio),'
         + '(Agosto),(Septiembre),(Octubre),(Diciembre)]+-[0-9]{2,15}$', fecha.lower()):
...
def confirmar(event):
    "We defined a new method for password confirmation"
...
# Crear componentes.
label = ttk.Label(root, text="Nombre de usuario: ")
label.place(x=5, y=20)
label1 = ttk.Label(root, text="Contraseña: ")
label1.place(x=5, y=50)
label2 = ttk.Label(root, text="Confirmar contraseña: ")
label2.place(x=5, y=80)
label3 = ttk.Label(root, text="Email: ")
label3.place(x=5, y=110)
label4 = ttk.Label(root, text="Sexo: ")
label4.place(x=5, y=140)
label5 = ttk.Label(root, text="Fecha de nacimiento: ")
...
var = tk.IntVar()
rb = ttk.Radiobutton(root, text="Hombre", variable=var, value=1)
rb.place(x=130, y=140)
rb1 = ttk.Radiobutton(root, text="Mujer", variable=var, value=2)
rb1.place(x=210, y=140)
entry4 = ttk.Entry(root)
entry4.place(x=130, y=170)
entry2.bind('<FocusOut>', confirmar)
btn = ttk.Button(root, text="Validar", command= validar())
